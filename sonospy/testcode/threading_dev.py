...
class Thread(_Verbose):
    ...
    def __init__(self, group=None, target=None, name=None,
        ...
        print "%%%%%%%%%%%%%%%% Thread.__init__ name: " + str(self.__name) + "  target: " + str(self.__target)
...
class _Timer(Thread):
    ...
    def __init__(self, interval, function, args=[], kwargs={}):
        print "^^^^^^^^^^^ Timer.__init__ func: " + str(function) + "  int: " + str(interval)
    ...
    def run(self):
        ...
        if not self.finished.is_set():
            print "^^^^^^^^^^^ Timer.call: " + str(self.function)
