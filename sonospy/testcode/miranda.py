...
#				'</SOAP-ENV:Envelope>' % (actionName,serviceType,argList,actionName)
		soapBody = 	'<?xml version="1.0"?>'\
				'<s:Envelope xmlns:ns0="urn:schemas-upnp-org:service:ContentDirectory:1" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">'\
				'<s:Body>'\
				'<ns0:%s>'\
				'%s'\
				'</ns0:%s>'\
				'</s:Body>'\
				'</s:Envelope>' % (actionName,argList,actionName)
