...
//                // fix to stop accordion changing width when width() or height() of menu are asked for
//                // note that currently the id of the div containing the accordion is hard coded!
//
//                var props = { position: "absolute" };
//                var w = 0;
//                $.swap($("#right")[0], props, function(){
//                     w = cmenu.menu.width();
//                });
//                var h = 0;
//                $.swap($("#right")[0], props, function(){
...
//					width:(w+cmenu.shadowWidthAdjust)+"px", 
//					height:(h+cmenu.shadowHeightAdjust)+"px", 
		...
		// Passes the event that caused the menu to be shown
		// Return false to cancel the default show operation
		beforeShow: function bs(e) { return true; },

		// A hook to call after the menu is shown, in case special processing needs to be done.
		// Passes the menu object
		afterShow: function as(m) {},
...
//            });
			...
			if (cmenu.constrainToScreen) {
				...
				maxRight += 30;     // fix for menu running off end of right of screen
				if (maxRight > ww) {
				    x -= (maxRight-ww);
			    }
			}
...
//		return this.each(function(){
		this.each(function(){
//			$(this).bind('contextmenu',function(e){if (beforeprocessmenu(e)!==false){cmenu.show(this,e);return false;}});
